    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="" method="post">
                ...
                <div class="form-group">
                    <label>ISBN No.</label>
                    <input type="number" name="book_isbn_no" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Book Price: </label>
                    <input type="text" name="book_price" class="form-control" required>
                </div>
                <button class="btn btn-dark" name="add_new_book">Add Book</button>
            </form>
        </div>
        <div class="col-md-4"></div>
    </div>
...
<?php
    if (isset($_POST['add_new_book'])){
        ...
        $sql = "INSERT INTO books VALUES (null, '$_POST[book_name]','$_POST[book_author]','$_POST[book_cat]',$_POST[book_isbn_no],$_POST[book_price])";
