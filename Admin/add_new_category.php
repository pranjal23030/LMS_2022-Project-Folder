    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <ul class="nav navbar-nav navbar-center">
                ...
                <li class="nav-item">
                    <a href="admin_index.php" class="nav-link" style="color: black">Issue Book</a>
                </li>
            </ul>
        </div>
    </nav>
...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="" method="post">
            ...
            <button class="btn btn-dark" name="add_category">Add Category</button>
    </div>
    <div class="col-md-4"></div>
</div>
</body>
...
<?php
    ...
    if (isset($_POST['add_category'])) {
        ...
        $sql = "INSERT INTO category VALUES ('','$_POST[category_name]')";
