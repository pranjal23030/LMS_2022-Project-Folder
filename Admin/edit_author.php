<?php
    ...
    $sql = "SELECT * FROM authors WHERE author_id = $_GET[id]";
    ...
    <div class="col-md-4">
        <form action="" method="post">
            <div class="form-group">
                ...
                <button class="btn btn-dark" name="update_author">Update author</button>
            </div>
            <div class="col-md-4"></div>
    </div>
</body>
...
<?php
    if(isset($_POST['update_author'])){
        ...
        $sql = "UPDATE authors SET author_name = '$_POST[author_name]' where author_id = $_GET[id]";
