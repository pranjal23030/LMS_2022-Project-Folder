<?php
    ...
    $sql = "SELECT * FROM books WHERE book_isbn_no = $_GET[id]";
        ...
        <form action="" method="post">
            <div class="form-group">
                <div class="form-group">
                    ...
                    <input type="number" name="book_isbn_no" value="<?php echo $book_isbn_no?>" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="category_id" value="<?php echo $category_id?>" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Book Price: </label>
                    <input type="number" name="book_price" value="<?php echo $book_price?>" class="form-control" required>
                </div>
            <button class="btn btn-dark" name="update_book">Update book</button>
    </div>
    <div class="col-md-4"></div>
</div>
</body>
...
<?php
    ...
    if (isset($_POST['update_book'])){
        ...
        $sql = "UPDATE books SET book_name = '$_POST[book_name]', author_id = $_POST[author_id], category_id = $_POST[category_id], book_price = $_POST[book_price] WHERE book_isbn_no = $_GET[id]";
