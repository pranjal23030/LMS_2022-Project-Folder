    ...
    <div class="col-md-4">
        <form action="" method="post">
            <div class="form-group">
                ...
                <button class="btn btn-dark" name="update_category">Update category</button>
            </div>
            <div class="col-md-4"></div>
    </div>
</body>
...
<?php
    if(isset($_POST['update_category'])){
        ...
        $sql = "UPDATE category SET category_name = '$_POST[category_name]' where category_id = $_GET[id]";
