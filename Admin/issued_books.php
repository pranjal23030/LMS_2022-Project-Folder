<?php
    ...
    //Query
    $sql = "SELECT issued_books.book_name, issued_books.book_author, issued_books.book_number, user.name FROM issued_books LEFT JOIN user on issued_books.student_id = user.id";
?>
