                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="edit_books.php?id=<?php echo $row['book_isbn_no'];?>">Edit</a></li>
                                        <li><a class="dropdown-item" href="delete_books.php?id=<?php echo $row['book_isbn_no'];?>">Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
