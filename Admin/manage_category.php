                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href="edit_category.php?id=<?php echo $row['category_id'];?>">Edit</a></li>
                                    <li><a class="dropdown-item" href="delete_category.php?id=<?php echo $row['category_id'];?>">Delete</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
