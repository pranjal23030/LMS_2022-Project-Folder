...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="" method="post">
            ...
            <button class="btn btn-dark" name="issue_book">Issue Book</button>
    </div>
    <div class="col-md-4"></div>
</div>
</body>
...
<?php
    if (isset($_POST['issue_book'])){
        ...
        $sql = "INSERT INTO issued_books VALUES (null, $_POST[book_number],'$_POST[book_name]','$_POST[book_author]',$_POST[student_id],1,'$_POST[issue_date]')";
        $run_sql = mysqli_query($connection, $sql);
