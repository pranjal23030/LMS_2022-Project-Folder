...
<div class="row">
    ...
    <div class="col-md-4">
        <form action="update_user.php" method="post">
            ...
            <div class="form-group">
                <label>Address:</label>
                <textarea class="form-control" name="address" id="" cols="30" rows="3" ><?php echo $address; ?></textarea>
            </div>
            <button class="btn btn-dark" type="submit" name="update" id="update">Update</button>
        </form>
    </div>
    <div class="col-md-4"></div>
</div>
